...
\includepdf[pages={1-},scale=0.90,pagecommand={\pagestyle{myruled}}]{cross_validated_posts/CV11_RFginigain.pdf}
\label{CV11_RFginigain}

\subsection{Limiting bootstrap sample size versus limiting maxnodes}
\includepdf[pages={1-},scale=0.90,pagecommand={\pagestyle{myruled}}]{cross_validated_posts/CV12_RFsampsize.pdf}
